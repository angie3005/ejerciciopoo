    ...
    <form>       
        <div class="container-fluid well">
          <div class="row clearfix">
             <form role="form" class="form-horizontal "action="liquidar_empleado.php">
                           ...
                           control-label">Cargo</label>
                            ...
                            <div class="form-group">
                             <label class="col-sm-3 control-label">Horas Trabajadas</label>
                              <div class="col-sm-6">
                               <input type="text" class="form-control"name="horas_trabajadas"id="horas_trabajadas" placeholder="Horas extras...">
                    </div>
                  </form>
                </div>
               </div>
